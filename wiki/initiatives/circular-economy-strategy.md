...
Funding secured in Year 3 includes a $20,000 USDN Emergent Learning Fund grant for equitable community engagement and a $10,000 State of Michigan grant ([[sources/annual-reports/a2zero-year3|a2zero-year3]]). Creating a circular economy strategy co-designed with a wide variety of Ann Arborites is a Year 4 priority, with a co-design process planned to continue advancing the strategy ([[sources/annual-reports/a2zero-year3|a2zero-year3]]).
