...
Ann Arbor expanded its public EV charging infrastructure during Year One of A2ZERO, including winning a grant to install four Direct Current Fast Chargers (DCFCs) at City Hall ([[sources/annual-reports/a2zero-year1|a2zero-year1]]). Year Two plans called for continued installation of EV and bike charging infrastructure throughout the city ([[sources/annual-reports/a2zero-year1|a2zero-year1]]).
