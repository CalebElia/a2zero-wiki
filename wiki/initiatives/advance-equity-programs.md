...
- source: '[[sources/cap/cap-2020]]'
  status: unverified
  target: OSI staff receive and lead continuing education about equity issues; hire
    equity fellow to help with aging in place efficiently work
  year: 2020
- source: '[[sources/cap/cap-2020]]'
  status: unverified
  target: OSI staff conduct baseline equity trainings with Energy and Environmental
    Commissioners; hire summer equity fellow; form OSI Equity Advisory Commission
  year: 2021
- source: '[[sources/cap/cap-2020]]'
  status: unverified
  target: All OSI programs have an equity focus; OSI staff reflect diversity of Ann
    Arbor and Washtenaw County; staff have strong working relationships with local
