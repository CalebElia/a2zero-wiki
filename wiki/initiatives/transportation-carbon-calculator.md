...
- source: '[[sources/annual-reports/a2zero-year2]]'
  status: unverified
  target: Initiate co-development of a carbon calculator using transportation metrics
    to inform the plan review process
  year: 2021
...
- vmt-reduction
- planning
title: Transportation Carbon Calculator for Plan Review
type: initiative
---
