...
- [x] **3.2 — Backfilled 2 of the 3 known v1 cases**, re-verified against current sources (Wheeler MW discrepancy, Solarize MW scope — both confirmed still live/unresolved as of Year 5). The third (facility audit count) turned out to be a recall gap, not a contradiction gap — spawned as a separate follow-up task rather than force-fit here.
