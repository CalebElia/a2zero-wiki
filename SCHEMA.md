...
3. **When no approved type fits at all**: write the page using the **closest approved
   ...
   `meta/schema-drift.md` automatically for HITL review.
...
(see `meta/relationship-lexicon.md`):
...
| `meta/` directory | Governance files (schema-drift, topic-candidates, relationship-lexicon) |
